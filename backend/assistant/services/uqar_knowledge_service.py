...
SOURCE_BY_INTENT = {
    ...
    "program_administration": ["uqar_programs", "uqar_admission", "uqar_main"],
    "bachelor_credits": ["uqar_programs", "uqar_main"],
